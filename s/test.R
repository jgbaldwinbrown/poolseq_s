...
print(1)
mySync <- read.sync(file="ex6.sync", gen=c(0, 10, 0, 10), repl=c(1, 1, 2, 2))
print(2)
print(mySync)
...
print(mytraj)
print(4)
mycov = coverage(mySync, c("2R", "3R"), c(2304, 2305), repl=c(1,2), gen=c(0,10))
mycov1 = coverage(mySync, c("2R", "3R"), c(2304, 2305), repl=c(1), gen=c(0,10))
print(5)
print(mycov)
print(6)

estimateNe(p0=mytraj1[,"F0"], pt=mytraj1[,"F10"], cov0=mycov1[,"F0.R1.cov"], covt=mycov1[,"F10.R1.cov"], t=10)
...
s = estimateSH(mytraj, Ne=1000, t=c(0,10), h=.5, simulate.p.value=TRUE)
print(8)
print(s)
print(9)
confint(s)
